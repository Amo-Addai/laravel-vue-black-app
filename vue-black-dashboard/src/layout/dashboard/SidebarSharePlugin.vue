    ...
    <div class="dropdown show-dropdown" :class="{show: isOpen}">
      ...
      <ul class="dropdown-menu" :class="{show: isOpen}">
        ...
        <li class="button-container">
          <a href="https://www.AUTO.com/product/vue-black-app-pro-laravel" target="_blank" class="btn btn-primary btn-block btn-round">Update</a>
          <a href="https://vue-black-app-laravel.AUTO.com/documentation/" target="_blank" class="btn btn-default btn-block btn-round">
            Documentation
          </a>
          <a
            href="https://www.AUTO.com/product/vue-black-app-laravel"
            target="_blank"
            rel="noopener"
          ...
          <a
            href="https://github.com/Amo-Addai/vue-black-app-laravel"
            target="_blank"
            rel="noopener"
...
<style scoped lang="scss">
  @import "~@/assets/sass/black-app/custom/variables";
  .settings-icon {
    cursor: pointer;
  }
  .badge-vue {
